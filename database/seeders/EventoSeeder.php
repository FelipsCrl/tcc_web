...
class EventoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Evento::create([
            ...
            'data_hora_evento' => '2024-09-20 10:00:00',
            ...
            'data_hora_limite_evento' => '2024-11-19 23:59:59',
        ...
        Evento::create([
            ...
            'data_hora_evento' => '2024-10-05 14:00:00',
            'id_instituicao' => 1, // Assumindo que o ID 1 existe na tabela instituicao
            'id_endereco' => 3, // Assumindo que o ID 3 existe na tabela endereco
            'data_hora_limite_evento' => '2024-10-04 23:59:59',
